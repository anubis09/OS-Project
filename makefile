...
CFLAGS_MIPS = -mips1 -mabi=32 -mno-gpopt -G 0 -mno-abicalls -fno-pic -mfp32 -std=c11
...
kernel : phase2/initialize.o phase1/asl.o phase1/pcb.o phase2/scheduler.o phase2/exceptions.o phase2/interrupts.o phase3/vmSupport.o phase3/sysSupport.o phase3/initProc.o phase2/include.o crtso.o libumps.o
	$(LD) -o $@ $^ $(LDFLAGS)

clean :
	-rm *.o phase1/*.o phase2/*.o phase3/*.o kernel kernel.*.umps 
