...
#define VALIDOFF VALIDON ^ ALLBITSON

/* EntryHI register constants */
#define GETPAGENO 0x3FFFF000
#define GETPFN 0xFFFFF000
...
#define GETDEVREGADDR(INTL, DN) (unsigned int *)(DEVREGBASE + (INTL - STARTINTLINEDEVICE) * 0x80 + (DN)*0x10)
#define GETPAGE(T) (((T & GETPAGENO) >> VPNSHIFT) & 0xFF)
